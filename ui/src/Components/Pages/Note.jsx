...
function Note() {
  const sampleNotes = [
    { id: 1, title: "MeetingMeeting Notes", content: "Discuss project milestones and deadlines." },
  ...
  return (
    <>
      {/* Add Note Form */}
      {open && (
        <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-xl shadow-md border border-gray-200 font-sans space-y-4">
